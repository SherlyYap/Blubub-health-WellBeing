...
class _HomeWorkoutPageState extends State<HomeWorkoutPage> {
  ...
  List<dynamic> get filteredWorkouts {
    ...
    return workouts.where((w) {
      ...
      final target = (w['targetMuscles'] != null && w['targetMuscles'].isNotEmpty)
      ...
      if (_selectedCategory != "All") {
        if (_selectedCategory == "Strength") {
          matchesCategory = target.contains("pectorals") ||
          ...
          matchesCategory =
              target.contains("legs") || target.contains("glutes") || target.contains("quads");
